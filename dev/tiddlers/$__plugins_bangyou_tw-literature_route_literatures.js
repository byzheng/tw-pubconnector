/*\
title: $:/plugins/bangyou/tw-literature/route/literature.js
 ...
 * 
 * Dependencies:
 *   - $:/plugins/bangyou/tw-literature/api/authoring.js (for author tag extraction)
 *   - $:/plugins/tiddlywiki/bibtex (for BibTeX deserialization)
 * 
 * @module $:/plugins/bangyou/tw-literature/route/literature.js
 * @method POST
 * @route /^\/literatures$/
 * @platforms ["node"]
...
(function () {
	...
	var authoring = require("$:/plugins/bangyou/tw-literature/api/authoring.js").Authoring();
