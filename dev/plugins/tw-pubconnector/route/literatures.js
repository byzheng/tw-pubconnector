/*\
title: $:/plugins/bangyou/tw-pubconnector/route/literature.js
 ...
 * 
 * Dependencies:
 *   - $:/plugins/bangyou/tw-pubconnector/api/authoring.js (for author tag extraction)
 *   - $:/plugins/tiddlywiki/bibtex (for BibTeX deserialization)
 * 
 * @module $:/plugins/bangyou/tw-pubconnector/route/literature.js
 * @method POST
 * @route /^\/literatures$/
 * @platforms ["node"]
